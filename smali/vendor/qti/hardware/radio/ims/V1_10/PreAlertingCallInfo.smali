...
.method public static final readVectorFromParcel(Landroid/os/HwParcel;)Ljava/util/ArrayList;
    ...
    .line 62
    .local v0, "_hidl_vec":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lvendor/qti/hardware/radio/ims/V1_10/PreAlertingCallInfo;>;"
    ...
    .line 72
    new-instance v5, Lvendor/qti/hardware/radio/ims/V1_10/PreAlertingCallInfo;

    invoke-direct {v5}, Lvendor/qti/hardware/radio/ims/V1_10/PreAlertingCallInfo;-><init>()V

    .line 73
    .local v5, "_hidl_vec_element":Lvendor/qti/hardware/radio/ims/V1_10/PreAlertingCallInfo;
    mul-int/lit16 v6, v4, 0x88

    int-to-long v6, v6

    invoke-virtual {v5, p0, v3, v6, v7}, Lvendor/qti/hardware/radio/ims/V1_10/PreAlertingCallInfo;->readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V

    .line 74
    invoke-virtual {v0, v5}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    .line 71
    .end local v5    # "_hidl_vec_element":Lvendor/qti/hardware/radio/ims/V1_10/PreAlertingCallInfo;
...
.method public static final writeVectorToParcel(Landroid/os/HwParcel;Ljava/util/ArrayList;)V
    ...
    .line 96
    .local p1, "_hidl_vec":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lvendor/qti/hardware/radio/ims/V1_10/PreAlertingCallInfo;>;"
    ...
    check-cast v4, Lvendor/qti/hardware/radio/ims/V1_10/PreAlertingCallInfo;

    mul-int/lit16 v5, v3, 0x88

    int-to-long v5, v5

    invoke-virtual {v4, v2, v5, v6}, Lvendor/qti/hardware/radio/ims/V1_10/PreAlertingCallInfo;->writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
...
.method public final equals(Ljava/lang/Object;)Z
    ...
    check-cast v2, Lvendor/qti/hardware/radio/ims/V1_10/PreAlertingCallInfo;

    .line 21
    .local v2, "other":Lvendor/qti/hardware/radio/ims/V1_10/PreAlertingCallInfo;
    iget v3, p0, Lvendor/qti/hardware/radio/ims/V1_10/PreAlertingCallInfo;->callId:I

    iget v4, v2, Lvendor/qti/hardware/radio/ims/V1_10/PreAlertingCallInfo;->callId:I
    ...
    .line 24
    :cond_3
    iget-object v3, p0, Lvendor/qti/hardware/radio/ims/V1_10/PreAlertingCallInfo;->callComposerInfo:Lvendor/qti/hardware/radio/ims/V1_6/CallComposerInfo;

    iget-object v4, v2, Lvendor/qti/hardware/radio/ims/V1_10/PreAlertingCallInfo;->callComposerInfo:Lvendor/qti/hardware/radio/ims/V1_6/CallComposerInfo;
    ...
    .line 27
    :cond_4
    iget-object v3, p0, Lvendor/qti/hardware/radio/ims/V1_10/PreAlertingCallInfo;->ecnamInfo:Lvendor/qti/hardware/radio/ims/V1_10/EcnamInfo;

    iget-object v4, v2, Lvendor/qti/hardware/radio/ims/V1_10/PreAlertingCallInfo;->ecnamInfo:Lvendor/qti/hardware/radio/ims/V1_10/EcnamInfo;
...
.method public final hashCode()I
    ...
    iget-object v2, p0, Lvendor/qti/hardware/radio/ims/V1_10/PreAlertingCallInfo;->ecnamInfo:Lvendor/qti/hardware/radio/ims/V1_10/EcnamInfo;
...
.method public final readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
    ...
    .line 85
    iget-object v0, p0, Lvendor/qti/hardware/radio/ims/V1_10/PreAlertingCallInfo;->ecnamInfo:Lvendor/qti/hardware/radio/ims/V1_10/EcnamInfo;

    const-wide/16 v1, 0x48

    add-long/2addr v1, p3

    invoke-virtual {v0, p1, p2, v1, v2}, Lvendor/qti/hardware/radio/ims/V1_10/EcnamInfo;->readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
